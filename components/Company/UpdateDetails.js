...
const UpdateDetails = ({ _id, _name, _link, _numberOfPhases, _maxAccounts, _maxCapital, _companyPhase1Name, _companyPhase2Name, _companyPhase3Name }) => {
  ...
  return (
    <div className="form form-small">
      ...
      <input type="number" placeholder="Number of Phases" className="input" value={numberOfPhases} onChange={(e) => setNumberOfPhases(e.target.value)} />
      <input type="number" placeholder="Maximum Accounts" className="input" value={maxAccounts} onChange={(e) => setMaxAccounts(e.target.value)} />
      <input type="number" placeholder="Maximum Capital" className="input" value={maxCapital} onChange={(e) => setMaxCapital(e.target.value)} />
