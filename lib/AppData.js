...
export const Schedule = {
  monday: {
    ...
    note: "Κλείνουμε 6:30-7:00 το απόγευμα! https://www.youtube.com/watch?v=agtV8D_g3oU&list=FLXKFG5XJ7Dx13N4mWsbuYUg&index=14",
  },
  tuesday: {
    dateString: "29 October",
    active: true,
    mode: "fast",
    schedule: {
      startingHour: 4,
    ...
    note: "Κλείνουμε 2:00-3:30",
  },
  wednesday: {
    dateString: "30 October",
    active: false,
    mode: "fast",
    schedule: {
      startingHour: 4,
      endingHour: 10,
      pairs: ["EURUSD", "AUDUSD", "GBPUSD", "USDJPY", "NZDUSD", "AUDJPY", "USDCHF"],
    },
    note: "Κλείνουμε το βράδυ στις 3:30-4:00 ωρα Ελλαδας",
  },
  thursday: {
    ...
    schedule: {
      startingHour: 4,
      endingHour: 9,
      pairs: ["EURUSD", "AUDUSD", "GBPUSD", "USDCAD", "NZDUSD", "USDCHF"],
    },
    note: "Κλείνουμε 1.30 - 2:00 το μεσημέρι. Μην ξεχάσετε!",
  },
  friday: {
    ...
    schedule: {
      startingHour: 4,
      endingHour: 10,
      pairs: ["EURUSD", "AUDUSD", "GBPUSD", "USDJPY", "NZDUSD", "AUDJPY"],
    },
    note: "Κλείνουμε 2:30 - 3:00 το μεσημέρι ώρα Ελλάδος",
  },
  saturday: {
    dateString: "",
    active: false,
