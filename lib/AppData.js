...
export const Schedule = {
  monday: {
    ...
    note: "Κλείνουμε το βράδυ 7-8. Όποιος μπορεί βάζει και δεύτερο trade πριν τις 12.",
  },
  tuesday: {
    dateString: "17 September",
    active: true,
    mode: "fast",
    schedule: {
      startingHour: 4,
    ...
    note: "Κλείνουμε 2:30 - 3:00.",
  },
  wednesday: {
    dateString: "18 September",
    active: true,
    mode: "slow",
    schedule: {
      startingHour: 4,
      endingHour: 12,
      pairs: ["AUDUSD", "USDJPY", "USDCAD", "NZDUSD", "AUDJPY", "USDCHF"],
    },
    note: "Κλείνουμε οπωσδήποτε 8:00 - 8:30 το βράδυ γιατί στις 9 το βράδυ έχει news!",
  },
  thursday: {
    dateString: "19 September",
    active: true,
    mode: "fast",
    schedule: {
      startingHour: 4,
    ...
    note: "Κλείνουμε 1.00 - 1:30 το μεσημέρι αλλιώς θα καούν όλα τα accounts! Μην ξεχάσετε!",
  },
  friday: {
    dateString: "20 September",
    active: true,
    mode: "slow",
    schedule: {
      startingHour: 4,
      endingHour: 10,
      pairs: ["EURUSD", "AUDUSD", "USDCAD", "NZDUSD", "USDCHF"],
    },
    note: "Κλείνουμε το μεσημέρι 2:00 - 2:30! Μην ξεχάσετε!",
  },
  saturday: {
    dateString: "",
    active: false,
