...
export const Schedule = {
  monday: {
    ...
    note: "Κλείνουμε 8-9 το βράδυ!",
  },
  tuesday: {
    dateString: "5 November",
    active: true,
    mode: "fast",
    schedule: {
      startingHour: 4,
  ...
  wednesday: {
    ...
    note: "Κλείνουμε το βράδυ στις 8-9 το βράδυ",
  },
  thursday: {
    dateString: "7 November",
    active: true,
    mode: "fast",
    schedule: {
      startingHour: 4,
    ...
    note: "Κλείνουμε 1.00 - 1:30 το μεσημέρι. Μην ξεχάσετε!",
  },
  friday: {
    dateString: "8 November",
    active: true,
    mode: "fast",
    schedule: {
      startingHour: 4,
