...
export const Schedule = {
  ...
  tuesday: {
    ...
    note: "Κλείνουμε 3:30 - 4:30 το απόγευμα αλλιώς θα καούν όλα τα accounts! Μην ξεχάσετε!",
  },
  wednesday: {
    dateString: "4 September",
    active: true,
    mode: "fast",
    schedule: {
      startingHour: 5,
    ...
    note: "Κλείνουμε 3:15 - 4:15 το απόγευμα αλλιώς θα καούν όλα τα accounts! Μην ξεχάσετε!",
  },
  thursday: {
    dateString: "5 September",
    active: true,
    mode: "fast",
    schedule: {
      startingHour: 4,
      endingHour: 9,
      pairs: ["EURUSD", "GBPUSD", "USDJPY", "USDCAD", "AUDJPY", "USDCHF"],
    },
    note: "Κλείνουμε 2:15 - 2:45 το μεσημέρι αλλιώς θα καούν όλα τα accounts! Μην ξεχάσετε!",
  },
  friday: {
    dateString: "6 September",
    active: false,
    mode: "fast",
    schedule: {
      startingHour: 4,
