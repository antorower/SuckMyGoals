...
export const Schedule = {
  monday: {
    ...
    note: "Κλείνουμε το βράδυ στις 7-8 οπωσδήποτε!",
  },
  tuesday: {
  ...
  wednesday: {
    ...
    note: "Κλείνουμε το μεσημέρι 2:00 - 2:30 οπωσδήποτε!",
  },
  thursday: {
    dateString: "3 October",
    active: false,
    mode: "fast",
    schedule: {
      startingHour: 4,
    ...
    note: "Κλείνουμε 2.30 - 3:00 το μεσημέρι. Μην ξεχάσετε!",
  },
  friday: {
    dateString: "4 October",
    active: true,
    mode: "fast",
    schedule: {
      startingHour: 4,
    ...
    note: "Κλείνουμε 2-3 το μεσημέρι. Όποιος δεν μπορεί να βάλει πριν τις 8 ας μην βάλει.",
  },
  saturday: {
    dateString: "",
    active: true,
