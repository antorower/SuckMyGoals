...
export const Schedule = {
  monday: {
    ...
    note: "Κλείνουμε το μεσημέρι 3:45 - 4:15.",
  },
  tuesday: {
    dateString: "24 September",
    active: true,
    mode: "fast",
    schedule: {
      startingHour: 4,
      endingHour: 10,
      pairs: ["EURUSD", "GBPUSD", "USDCAD", "USDCHF"],
    },
    note: "Κλείνουμε 4:00 - 4:30.",
  },
  wednesday: {
    dateString: "25 September",
    active: true,
    mode: "slow",
    schedule: {
      startingHour: 4,
    ...
    note: "Κλείνουμε 7:00 - 8:00 το βράδυ",
  },
  thursday: {
    dateString: "26 September",
    active: true,
    mode: "fast",
    schedule: {
      startingHour: 4,
  ...
  friday: {
    ...
    note: "Κλείνουμε το μεσημέρι 2:30 - 3:00. Μην ξεχάσετε!",
  },
  saturday: {
    dateString: "",
    active: true,
