...
export const Companies = [
  ...
  },
  {
    ...
    waitingPurchaseInstructions: "Αγόρασε Funded Next Challenge 2-step όπως στην αρχή.",
  ...
  },
  {
    ...
    waitingPurchaseInstructions: "Αγόρασε Stellar 2-Step! Όχι Challenge όπως αγοράσαμε στην αρχή!",
    needUpgradeInstructions: "Χρειάζεται 5 minimum trading days για να περάσεις. Αν πιάσεις τον στόχο πριν τις 5 trading days βάζε τις υπόλοιπες 0.01.",
    waitingPayoutInstructions: "Pending...",
    payoutRequestDoneInstructions: "Pending...",
    moneySendedInstructions: "Pending...",
...
//["EURUSD", "AUDUSD", "GBPUSD", "USDJPY", "USDCAD", "NZDUSD", "AUDJPY", "USDCHF"]
export const Pairs = [
  {
    pair: "EURUSD",
    fastMode: {
...
export const Schedule = {
  monday: {
    dateString: "9 September",
    active: true,
    mode: "slow", // slow or fast
    schedule: {
      startingHour: 4,
      endingHour: 14,
      pairs: ["EURUSD", "AUDUSD", "GBPUSD", "USDJPY", "USDCAD", "NZDUSD", "AUDJPY"],
    },
    note: "Κλείνουμε το βράδυ 7-8",
  },
  tuesday: {
    dateString: "10 September",
    active: true,
    mode: "slow",
    schedule: {
      startingHour: 4,
      endingHour: 12,
      pairs: ["AUDUSD", "USDJPY", "NZDUSD", "AUDJPY", "USDCHF"], // "EURUSD", "GBPUSD",
    },
    note: "Ανοίξτε trades ΠΡΩΤΑ στην Funded Next. Κλείνουμε το βράδυ 7-8",
  },
  wednesday: {
    ...
    schedule: {
      startingHour: 4,
      endingHour: 10,
      pairs: ["USDCHF", "AUDUSD", "USDJPY", "USDCAD", "NZDUSD", "AUDJPY"],
    },
    note: "Κλείνουμε 2:30 - 3:00 το μεσημέρι αλλιώς θα καούν όλα τα accounts! Μην ξεχάσετε!",
  },
  thursday: {
    dateString: "12 September",
    active: true,
    mode: "fast",
    schedule: {
      startingHour: 4,
      endingHour: 11,
      pairs: ["EURUSD", "AUDUSD", "GBPUSD", "USDJPY", "USDCAD", "AUDJPY"],
    },
    note: "Κλείνουμε 2:15 - 2:45 το μεσημέρι αλλιώς θα καούν όλα τα accounts! Μην ξεχάσετε!",
  },
  friday: {
    dateString: "13 September",
    active: true,
    mode: "slow",
    schedule: {
      startingHour: 4,
