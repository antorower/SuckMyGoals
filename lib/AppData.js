export const Strategy = {
  maxRiskToRewardRatio: 1.5, // Πάντα μεγαλύτερο του ενός
    ...
    phases: [
      {
        ...
        instructions: "There are no instructions for evaluation",
        weight: 1,
      },
      {
        name: "Verification",
        ...
        maxDrawdown: 0.1,
        maxRiskPerTrade: 0.03,
        instructions: "There are no instructions for verification",
        weight: 2,
      },
      {
        name: "Funded",
        ...
        instructions: "There are no instructions for funded",
        weight: 3,
      },
    ],
    accounts: [
    ...
    phases: [
      {
        ...
        maxDrawdown: 0.1,
        maxRiskPerTrade: 0.03,
        instructions: "There are no instructions for step 1",
        weight: 1,
      },
      {
        name: "Step 2",
        ...
        maxDrawdown: 0.1,
        maxRiskPerTrade: 0.03,
        instructions: "There are no instructions for step 2",
        weight: 2,
      },
      {
        name: "Funded",
...
export const Schedule = {
  ...
  thursday: {
    ...
    note: "No trades allowed today...",
  },
  friday: {
    dateString: "16 August",
    active: true,
    mode: "slow", // slow or fast
    schedule: {
      startingHour: 2,
