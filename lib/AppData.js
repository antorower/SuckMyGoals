...
export const Schedule = {
  monday: {
    dateString: "23 December",
    active: false,
    mode: "fast", // slow or fast
    schedule: {
      startingHour: 4,
      endingHour: 10,
      pairs: ["EURUSD", "AUDUSD", "GBPUSD", "USDJPY", "AUDJPY"],
    },
    note: "Κλείνουμε 2:30 - 3:00",
  },
  tuesday: {
    dateString: "7 January",
    active: true,
    mode: "fast", // slow or fast
    schedule: {
      startingHour: 4,
  ...
  wednesday: {
    dateString: "8 January",
    active: true,
    mode: "fast",
    schedule: {
      startingHour: 4,
      endingHour: 10,
      pairs: ["EURUSD", "AUDUSD", "GBPUSD", "USDJPY", "USDCAD", "AUDJPY", "USDCHF"],
    },
    note: "Κλείνουμε 2:00 - 2:30",
  },
  thursday: {
    dateString: "9 January",
    active: true,
    mode: "fast",
    schedule: {
      startingHour: 4,
    ...
    note: "Κλείνουμε 8:00 - 8:30 το βράδυ",
  },
  friday: {
    dateString: "10 January",
    active: true,
    mode: "slow",
    schedule: {
      startingHour: 4,
