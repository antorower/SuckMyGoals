...
export const Schedule = {
  monday: {
    ...
    note: "Κλείνουμε το βράδυ στις 7-8",
  },
  tuesday: {
    dateString: "15 October",
    active: true,
    mode: "fast",
    schedule: {
      startingHour: 4,
    ...
    note: "Κλείνουμε το βράδυ στις 2:30 - 3:00",
  },
  wednesday: {
    dateString: "16 October",
    active: true,
    mode: "slow",
    schedule: {
      startingHour: 4,
  ...
  thursday: {
    ...
    note: "Κλείνουμε 2.00 - 2:30 το μεσημέρι. Μην ξεχάσετε!",
  },
  friday: {
    dateString: "18 October",
    active: true,
    mode: "slow",
    schedule: {
      startingHour: 4,
      endingHour: 12,
      pairs: ["AUDUSD", "USDJPY", "USDCAD", "AUDJPY", "USDCHF"],
    },
