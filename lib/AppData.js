...
export const Schedule = {
  monday: {
    dateString: "10 February",
    active: true,
    mode: "fast", // slow or fast
    schedule: {
      startingHour: 4,
      endingHour: 10,
      pairs: ["EURUSD", "AUDUSD", "GBPUSD", "USDJPY", "USDCAD", "NZDUSD", "USDCHF"],
    },
    note: "Κλείνουμε 7-8 το βράδυ",
  },
  tuesday: {
    dateString: "11 February",
    active: true,
    mode: "fast", // slow or fast
    schedule: {
      startingHour: 4,
  ...
  thursday: {
    dateString: "13 February",
    active: false,
    mode: "fast",
    schedule: {
      startingHour: 4,
      endingHour: 10,
      pairs: ["AUDUSD", "USDJPY", "USDCAD", "NZDUSD", "USDCHF"],
    },
    note: "Κλείνουμε 2:30 - 3:00",
  },
  friday: {
