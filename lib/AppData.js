...
export const Schedule = {
  ...
  friday: {
    ...
    schedule: {
      startingHour: 4,
      endingHour: 10,
      pairs: ["AUDUSD", "USDJPY", "USDCAD", "NZDUSD", "AUDJPY"],
    },
    note: "Κλείνουμε 2.30 - 3:00 το μεσημέρι οπωσδήποτε!",
  },
  saturday: {
    dateString: "",
    active: true,
