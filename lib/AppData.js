export const Strategy = {
  maxRiskToRewardRatio: 2, // Πάντα μεγαλύτερο του ενός
...
export const Schedule = {
  ...
  tuesday: {
    ...
    note: "Πρέπει αν κλείσουμε τα trades 3:30 - 4:30 το απόγευμα αλλιώς θα καούν όλα τα accounts! Μην ξεχάσετε!! Διορθώνω ένα λαθάκι και ανοίγω ξανά να βάλουμε trades!",
  },
  wednesday: {
