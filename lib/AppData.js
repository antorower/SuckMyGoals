...
export const Schedule = {
  ...
  wednesday: {
    ...
    note: "Κλείνουμε 3:00 - 3:30",
  },
  thursday: {
    dateString: "30 January",
    active: true,
    mode: "fast",
    schedule: {
      startingHour: 4,
  ...
  friday: {
    dateString: "31 January",
    active: false,
    mode: "fast",
    schedule: {
      startingHour: 4,
      endingHour: 10,
      pairs: ["AUDUSD", "USDJPY", "USDCAD", "AUDJPY"],
    },
    note: "Κλείνουμε το βράδυ 7-8",
  },
  saturday: {
    ...
    schedule: {
      startingHour: 4,
      endingHour: 16,
      pairs: ["AUDUSD", "USDJPY", "USDCAD", "NZDUSD"],
    },
