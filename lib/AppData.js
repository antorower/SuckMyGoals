...
export const Schedule = {
  ...
  tuesday: {
    ...
    schedule: {
      startingHour: 4,
      endingHour: 10,
      pairs: ["EURUSD", "AUDUSD", "GBPUSD", "USDCAD", "USDCHF"],
    },
    note: "Κλείνουμε 2 με 2:30",
  },
  wednesday: {
    dateString: "18 June",
    active: true,
    ...
    schedule: {
      startingHour: 4,
      endingHour: 10,
      pairs: ["EURUSD", "AUDUSD", "USDJPY", "USDCAD", "USDCHF"],
    },
  ...
  friday: {
    ...
    schedule: {
      startingHour: 4,
      endingHour: 10,
      pairs: ["EURUSD", "AUDUSD", "USDCAD", "USDCHF"],
    },
    note: "Κλείνουμε 7 το βράδυ",
  },
  saturday: {
    dateString: "",
    active: false,
