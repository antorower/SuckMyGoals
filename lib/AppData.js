...
export const Schedule = {
  ...
  tuesday: {
    dateString: "19 November",
    active: true,
    mode: "fast",
    schedule: {
      startingHour: 4,
      endingHour: 10,
      pairs: ["EURUSD", "AUDUSD", "USDJPY", "USDCAD", "NZDUSD", "AUDJPY", "USDCHF"],
    },
    note: "Κλείνουμε 2-3 το μεσημέρι",
  },
  wednesday: {
    dateString: "20 November",
    active: true,
    mode: "slow",
    schedule: {
      startingHour: 4,
    ...
    note: "Κλείνουμε στις 7-8 το βραδυ",
  },
  thursday: {
    dateString: "21 November",
    active: true,
    mode: "fast",
    schedule: {
      startingHour: 4,
      endingHour: 10,
      pairs: ["AUDUSD", "GBPUSD", "USDCAD", "NZDUSD", "USDCHF"],
    },
    note: "Κλείνουμε στις 2-3 το μεσημέρι",
  },
  friday: {
